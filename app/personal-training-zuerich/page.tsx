...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://personal-training-zurich.vercel.app/personal-training-zuerich' },
...
const jsonLd = {
  ...
  '@type': 'BreadcrumbList',
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://personal-training-zurich.vercel.app' },
    { '@type': 'ListItem', position: 2, name: 'Personal Training Zürich', item: 'https://personal-training-zurich.vercel.app/personal-training-zuerich' },
  ],
}
        ...
        <section className="section-padding bg-background">
          <div className="container-max max-w-4xl prose prose-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="p-6 rounded-xl bg-[hsl(0,0%,11%)] text-white">
                <p className="font-bold text-lg mb-1 text-white">Quartals-Abo</p>
                <p className="text-2xl font-bold text-primary mb-2">CHF 600/Quartal</p>
                <p className="text-sm text-white/60">4 Sessions/Monat (12 Sessions). Spart CHF 300 gegenüber Einzelbuchungen.</p>
              </div>
            </div>
