...
export default function KontaktContent() {
  const { t } = useLanguage()
  const hoursLines = t('kontakt.hoursValue').split('\n')
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                <div className="p-6 rounded-2xl bg-secondary flex items-start gap-4">
                  ...
                  <div>
                    <h2 className="font-semibold mb-1">{t('kontakt.location')}</h2>
                ...
                <div className="p-6 rounded-2xl bg-secondary flex items-start gap-4">
                  ...
                  <div>
                    <h2 className="font-semibold mb-1">{t('kontakt.email')}</h2>
                ...
                <div className="p-6 rounded-2xl bg-secondary flex items-start gap-4">
                  ...
                  <div>
                    <h2 className="font-semibold mb-1">{t('kontakt.hours')}</h2>
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold text-white">{t('kontakt.whatsappLabel')}</p>
                    <p className="text-white/80 text-sm">{t('kontakt.whatsappSub')}</p>
                  </div>
                </a>
              </div>
