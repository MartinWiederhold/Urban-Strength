...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://momentum-zurich.ch',
    languages: { 'de-CH': 'https://momentum-zurich.ch', 'de': 'https://momentum-zurich.ch' },
  },
  openGraph: {
    type: 'website',
    locale: 'de_CH',
    url: 'https://momentum-zurich.ch',
...
const jsonLdLocalBusiness = {
  ...
  '@id': 'https://momentum-zurich.ch/#business',
  ...
  url: 'https://momentum-zurich.ch',
  image: 'https://momentum-zurich.ch/og-image.jpg?v=2',
...
const jsonLdImage = {
  '@context': 'https://schema.org',
  '@type': 'ImageObject',
  url: 'https://momentum-zurich.ch/og-image.jpg?v=2',
  width: 938,
  height: 964,
