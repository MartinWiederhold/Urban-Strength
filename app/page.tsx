...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://momentum-zurich.vercel.app',
    languages: { 'de-CH': 'https://momentum-zurich.vercel.app', 'de': 'https://momentum-zurich.vercel.app' },
  },
  openGraph: {
    type: 'website',
    locale: 'de_CH',
    url: 'https://momentum-zurich.vercel.app',
...
const jsonLdLocalBusiness = {
  ...
  '@id': 'https://momentum-zurich.vercel.app/#business',
  ...
  url: 'https://momentum-zurich.vercel.app',
  image: 'https://momentum-zurich.vercel.app/og-image.jpg?v=2',
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      { '@type': 'Offer', name: 'Personal Training 1:1', price: '85', priceCurrency: 'CHF' },
...
const jsonLdImage = {
  '@context': 'https://schema.org',
  '@type': 'ImageObject',
  url: 'https://momentum-zurich.vercel.app/og-image.jpg?v=2',
  width: 938,
  height: 964,
