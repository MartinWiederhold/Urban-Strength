      ...
      <div className="container-max">
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-[1.35fr_0.65fr] md:gap-14">
          ...
          <div className="animate-slide-up order-1 flex justify-center md:order-2 md:justify-end">
            <div className="relative h-[68vw] w-[68vw] max-h-[28.5rem] max-w-[28.5rem] translate-x-14 overflow-hidden rounded-full ring-1 ring-black/10 sm:h-[26rem] sm:w-[26rem] md:h-[28.5rem] md:w-[28.5rem] md:translate-x-[4.1rem] lg:translate-x-[9.8rem]" style={{ backgroundColor: '#060607' }}>
              <Image
